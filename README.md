...
- 🗂️ **Interactive Azure Blades**: Click any pipeline run, branch policy, commit, or work item to slide in a deep telemetry blade from the right with visual stage topology graphs and diagnostic agent logs.
